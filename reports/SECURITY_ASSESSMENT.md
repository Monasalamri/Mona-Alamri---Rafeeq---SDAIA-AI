...
- New synthetic case | الحالة الاصطناعية الجديدة: `{"asset": "Refund write", "case_id": "L-SEC-02", "control": "Trusted approval metadata + amount gate", "expected_flag": "approval_bypass", "payload_length": 268}`
...
- Assessment run ID | معرّف التقييم: `run-763d474f9e634b02`
